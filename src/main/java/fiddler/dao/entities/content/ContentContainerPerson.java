...
@Entity
@Table(name = "content_container_person", schema = "public", catalog = "indoc")
public class ContentContainerPerson {
	private int id;
	...
	public boolean equals(Object object) {
		...
		ContentContainerPerson that = (ContentContainerPerson) object;
