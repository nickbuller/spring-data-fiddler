...
@Entity
@Table(name = "event_tag_value", schema = "public", catalog = "indoc")
public class EventTagValue {
    private int id;
    ...
    public boolean equals(Object object) {
        ...
        EventTagValue that = (EventTagValue) object;

        if (id != that.id) return false;
        if (eventId != null ? !eventId.equals(that.eventId) : that.eventId != null) return false;
        if (eventTagId != null ? !eventTagId.equals(that.eventTagId) : that.eventTagId != null) return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (eventTagId != null ? eventTagId.hashCode() : 0);
