...
@Entity
@Table(name = "roles_have_hop_privileges", schema = "public", catalog = "indoc")
public class RolesHaveHopPrivileges {
    private int id;
    private int roleId;
    ...
    public boolean equals(Object object) {
        ...
        RolesHaveHopPrivileges that = (RolesHaveHopPrivileges) object;
