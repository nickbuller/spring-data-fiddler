...
public class AddressTagValue {
    ...
    public void setAddressTagId(Integer addressTagId) {
    ...
    public boolean equals(Object object) {
        ...
        AddressTagValue that = (AddressTagValue) object;

        if (id != that.id) return false;
        if (creatorid != that.creatorid) return false;
        if (addressId != null ? !addressId.equals(that.addressId) : that.addressId != null) return false;
        if (addressTagId != null ? !addressTagId.equals(that.addressTagId) : that.addressTagId != null) return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (addressTagId != null ? addressTagId.hashCode() : 0);
