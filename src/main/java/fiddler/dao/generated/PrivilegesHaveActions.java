...
@Entity
@Table(name = "privileges_have_actions", schema = "public", catalog = "indoc")
public class PrivilegesHaveActions {
    private int id;
    ...
    public boolean equals(Object object) {
        ...
        PrivilegesHaveActions that = (PrivilegesHaveActions) object;
