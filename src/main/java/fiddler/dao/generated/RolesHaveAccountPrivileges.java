...
@Entity
@Table(name = "roles_have_account_privileges", schema = "public", catalog = "indoc")
public class RolesHaveAccountPrivileges {
    private int id;
    private int roleId;
    ...
    public boolean equals(Object object) {
        ...
        RolesHaveAccountPrivileges that = (RolesHaveAccountPrivileges) object;
