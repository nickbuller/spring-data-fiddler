...
@Entity
@Table(name = "roles_have_container_privileges", schema = "public", catalog = "indoc")
public class RolesHaveContainerPrivileges {
    private int id;
    private int roleId;
    ...
    public boolean equals(Object object) {
        ...
        RolesHaveContainerPrivileges that = (RolesHaveContainerPrivileges) object;
