...
public class AddressTypeTag {
    ...
    public void setAddressTagId(int addressTagId) {
    ...
    public boolean equals(Object object) {
        ...
        AddressTypeTag that = (AddressTypeTag) object;

        if (id != that.id) return false;
        if (addressTypeId != that.addressTypeId) return false;
        if (addressTagId != that.addressTagId) return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + id;
        result = 31 * result + addressTypeId;
        result = 31 * result + addressTagId;
