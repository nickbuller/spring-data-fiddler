...
//
//@Entity
//@Table(name = "article_type_tag", schema = "public", catalog = "indoc")
...
//
//        ArticleTypeTag that = (ArticleTypeTag) object;
//
//        if (articleTagId != that.articleTagId) return false;
